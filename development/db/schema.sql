...
create table session (id uuid not null, description varchar(255), end_date timestamp, start_date timestamp, subject varchar(255), state varchar(255), sig_id uuid, contact_person_id uuid, primary key (id));
