    ...
    alter table if exists session_attendance_list 
       add constraint UK_b9c4s26st356o6ow4tm28ce8y unique (attendance_list_id)

    alter table if exists session_feedback_list 
    ...
    alter table if exists online_session 
       add constraint FKpnckfxtdir6l0vbnvgmtg59jn 
       foreign key (id) 
       references session
    ...
    alter table if exists physical_session 
       add constraint FK9gcnykp23ppmgminee010gl0i 
       foreign key (id) 
       references session
    ...
    alter table if exists sig 
       add constraint FKrj0kkqd2cj3krq8wirxi369c2 
       foreign key (manager_id) 
       references person

    alter table if exists sig_organizers 
    ...
    alter table if exists teams_online_session 
       add constraint FKbgq7y6d0y3f2fxyeheubp9q17 
       foreign key (id) 
    ...
    alter table if exists teams_online_session 
       add constraint FKbxh017y4ppglg7ogyfrv36wsh 
       foreign key (session_id) 
       references online_session
