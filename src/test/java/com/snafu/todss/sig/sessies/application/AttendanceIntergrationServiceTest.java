...
import static com.snafu.todss.sig.sessies.domain.session.SessionState.*;
...
@SpringBootTest
public class AttendanceIntergrationServiceTest {
    @Autowired
    ...
    void updateAttendance() {
        AttendanceRequest request = new AttendanceRequest(NO_SHOW, true);
